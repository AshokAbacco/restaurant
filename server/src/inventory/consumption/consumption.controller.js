...
// by hand, before order completion actually calls this automatically (it
// still doesn't — see the note in consumption.service.js). Once that's
// wired up, its order-completion code should call
// consumptionService.consumeForSale(...) directly (as a function call, not
// an HTTP round-trip) — this route can stay for manual corrections/testing,
// or be removed later.
